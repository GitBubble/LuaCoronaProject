...
-- Create captions
local hourLabel = display.newText( clock, "hours ", 220, 100, native.systemFont, 140 )
hourLabel:setFillColor( 131/255, 1, 131/255 )

local minuteLabel = display.newText( clock, "minutes ", 220, 250, native.systemFont, 140 )
minuteLabel:setFillColor( 131/255, 1, 131/255 )

local secondLabel = display.newText( clock, "seconds ", 210, 400, native.systemFont, 140 )
